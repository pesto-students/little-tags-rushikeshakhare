...
export function initPaymentRazorpay(totalAmount: number, description: string) {
    ...
    return new Promise(async (resolve, reject) => {
        ...
        const result: any = await NetworkManager.post("https://glacial-hollows-06272.herokuapp.com/payment", { amount: totalAmount * 100, receipt: 'receipt-' + Date.now().toString() });
        ...
        const options = {
            ...
            prefill: {
                name: "Ashim",
                email: "ashimrajkonwar@gmail.com",
                contact: "9101290771",
            },
            notes: {
