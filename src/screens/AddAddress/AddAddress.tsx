...
export const AddAddress = connect()(({ history }: IAddAddressProps) => {
  ...
  const handleFormChange = (event: any) => {
    ...
    switch (name) {
      case "firstName":
        if (value.length === 0)
          errors.firstName = ADD_ADDRESS.FIRST_NAME_VALIDATION_MESSAGE;
      ...
      case "lastName":
        if (value.length === 0)
          errors.lastName = ADD_ADDRESS.LAST_NAME_VALIDATION_MESSAGE;
      ...
      case "email":
        if (value.length === 0)
          errors.email = ADD_ADDRESS.EMAIL_REQUIRED_MESSAGE;
        else if (!validEmailRegex.test(value))
          errors.email = ADD_ADDRESS.EMAIL_VALIDATION_MESSAGE;
        else errors.email = "";
        setEmail(value);
        break;
      ...
      case "mobile":
        if (value.length === 0)
          errors.mobile = ADD_ADDRESS.MOBILE_VALIDATION_MESSAGE;
        else errors.mobile = "";
        setMobile(value);
        break;
      ...
      case "addressLine1":
        if (value.length === 0)
          errors.addressLine1 = ADD_ADDRESS.ADDRESS_LINE_1_VALIDATION_MESSAGE;
      ...
      case "addressLine2":
        if (value.length === 0)
          errors.addressLine2 = ADD_ADDRESS.ADDRESS_LINE_2_VALIDATION_MESSAGE;
      ...
      case "pincode":
        if (value.length === 0)
          errors.pincode = ADD_ADDRESS.PINCODE_VALIDATION_MESSAGE;
        else errors.pincode = "";
        setPincode(value);
        break;
    }
  ...
  const handleFormSubmit = () => {
    ...
    // Validation 2
    Object.values(addressObj).forEach(
    ...
    <div className="add-address">
      ...
      <div className="add-address-form d-flex">
        ...
        <div className="add-address-form-section-right">
          <FormGroup>
            <label htmlFor="" className="input-label">
              {ADD_ADDRESS.ADDRESS_LINE_1_LABEL}
            </label>
            <input
              value={addressLine1}
              onChange={handleFormChange}
