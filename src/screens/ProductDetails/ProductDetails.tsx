            ...
            >
                ...
                <div className="product-details-container">
                    <div className="carousel-holder left">
                        <ImageCarousel images={[imgCarousel3, imgCarousel2, imgCarousel1, imgCarousel4]} width={360} height={480} />
                    </div>
                    <div className="content-holder left">
                        <div className="product-details-content">
                            ...
                            <div className="details">
                                ...
                                <br/><br/>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed 
                            </div>

                            <div className="size-selection">
                                <div className="selection-title">Size</div>
                                <SizeSelect sizes={sizeList} handleSizeSelect={this.selectProductSize} />
                            </div>

                            <div className="quantity-selection">
                                <div className="quantity-selection-title">Quantity</div>
                                <ItemQuantity quantity={1} handleChange={this.handleQuantityChange}  />
                            </div>
                            <button disabled={ selectedSize === null } className="add-to-cart btn-flat pointer">
                                <img src={imgCart} />
                                ADD TO CART
                            </button>
                        </div>
